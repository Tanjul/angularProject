...
export class OverlaySidePanelService {
  ...
  isValueChanged = new BehaviorSubject<boolean>(false);
  constructor() {
  ...
  public onValueChange(): Observable<boolean> {
    return this.isValueChanged.asObservable();
  }

  public setValue(value: boolean): void {
    this.isValueChanged.next(value);
  }
}